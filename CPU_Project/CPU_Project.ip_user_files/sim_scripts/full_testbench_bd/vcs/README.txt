...
#
# Generated by export_simulation on Fri Mar 05 16:51:16 +0100 2021
#
################################################################################
...
'-reset_run' switch to the './full_testbench_bd.sh' script.

./full_testbench_bd.sh -reset_run
...
./full_testbench_bd.sh -noclean_files

For more information on the script, please type './full_testbench_bd.sh -help'.
