...
################################################################
# This is a generated script based on design: control_unit_tb_auto_bd
#
...
# source control_unit_tb_auto_bd_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# alu, alu_input_output_reg, alu_input_output_reg, control_unit, general_registers
...
set design_name control_unit_tb_auto_bd
...
proc create_root_design { parentCell } {
  ...
  set program_data [ create_bd_port -dir I -from 15 -to 0 program_data ]
  ...
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins alu_0/clk] [get_bd_pins alu_op_A/clk] [get_bd_pins alu_op_B/clk] [get_bd_pins control_unit_0/clk] [get_bd_pins general_registers_0/clk]
  ...
  connect_bd_net -net control_unit_0_register_enable [get_bd_pins control_unit_0/register_enable] [get_bd_pins general_registers_0/enable]
  connect_bd_net -net control_unit_0_register_read [get_bd_pins control_unit_0/register_read] [get_bd_pins general_registers_0/read]
  ...
  connect_bd_net -net control_unit_0_register_write [get_bd_pins control_unit_0/register_write] [get_bd_pins general_registers_0/write]
  connect_bd_net -net cu_enable_1 [get_bd_ports cu_enable] [get_bd_pins control_unit_0/enable]
  connect_bd_net -net general_registers_0_data_out [get_bd_ports gen_reg_data_out] [get_bd_pins alu_op_A/data_in] [get_bd_pins alu_op_B/data_in] [get_bd_pins general_registers_0/data_out]
  connect_bd_net -net program_data_1 [get_bd_ports program_data] [get_bd_pins control_unit_0/program_data]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins alu_0/reset] [get_bd_pins alu_op_A/reset] [get_bd_pins alu_op_B/reset] [get_bd_pins control_unit_0/reset] [get_bd_pins general_registers_0/reset]
